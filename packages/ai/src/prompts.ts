...
- **learnPreference**: Persist how much each evaluation dimension matters to the user (comp, remote, growth, etc.) so future fit scores reflect their priorities. Use when the user says what matters to them ("I care more about pay and remote").
