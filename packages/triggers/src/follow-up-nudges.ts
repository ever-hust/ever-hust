 ...
 * `POST /api/cron/follow-up-nudges` (see `work/follow-up-nudges.ts`). Retries are safe: each user
 * is claimed atomically for the 3-day cooldown before the email goes out.
 */
